...
public class RequestForBook extends AbstractAction {
    ...
    public String execute(HttpServletRequest request, HttpServletResponse response) {
        ...
        try {
            ...
            return "redirect:user-cabinet&notification=Failed to add book";
        }
        Book book = new Book();
        book.setId(id);
        ...
        try {
            ...
            throw new ActionException("Failed to update subscription", e);
        ...
        try {
            ...
            log.error("Failed to commint and stop transaction", e);
            throw new ActionException(e);
        }
